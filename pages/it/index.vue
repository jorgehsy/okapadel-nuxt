    ...
    <section class="two-col-section w-text green-bg d-flex">
      <div class="container">
        <div class="row d-flex align-items-center">
          <div class="col-md-6">
            <nuxt-img 
              loading="lazy" src="/images/home/somos-fabricantes-de-espacios-de-padel-min.webp"
            />
          </div>
        ...
        <div class="row">
          <div class="col-md-12 text-center">
            <h2 class="fw-section-title">
              <strong>Progetti di campi da padel</strong> di nostra realizzazione.
            </h2>
            <Carousel :items="projects" to="/it/progetti" button="Guarda di più" />
          </div>
        </div>
      </div>
    </section>
...
const { data } = await useAsyncData(
  'homepage',
  () => find<DefaultContent>('homepage', {locale: "it"})
)
