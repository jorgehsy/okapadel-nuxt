    ...
    <section class="two-col-section">
      <div class="container">
        <div class="row d-flex align-items-center">
          <div class="col-md-6">
            <nuxt-img  loading="lazy" src="/images/soluciones/cubrimos-las-instalaciones-del-club-min.jpg" alt="Coperture per campi da padel" />
          </div>
          <div class="col-md-6">
      ...
      <div class="container">
        <div class="row d-flex align-items-center">
          <div class="col-md-6 order-md-12">
            <nuxt-img loading="lazy" src="/images/soluciones/instalacion-de-pistas-de-padel-min.jpg" alt="Installazioni di campi da padel" />
          </div>
    ...
    <section class="two-col-section">
      <div class="container">
        <div class="row d-flex align-items-center flex-column-reverse flex-md-row">
          <div class="col-md-6 ">
            <nuxt-img  loading="lazy" src="/images/soluciones/iluminacion-y-climatizacion-de-pistas-de-padel-min.jpg" alt="Illuminazione, climatizzazione e stampa personalizzata dei campi da padel" />
          </div>
          <div class="col-md-6">
