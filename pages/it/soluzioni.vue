    ...
    <section class="two-col-section">
      <div class="container">
        <div class="row d-flex align-items-center">
          <div class="col-md-6">
            <nuxt-img  loading="lazy" src="/images/soluciones/cubrimos-las-instalaciones-del-club-min.webp" alt="Coperture per campi da padel" />
          </div>
          <div class="col-md-6">
            <div class="mb-3" v-html="content.firstSection?.rightColumn"></div>
            <div class="text-center">
              <NuxtLink class="btn btn-secondary" rel="" to="/it/coperture"
              >Vedi coperture</NuxtLink>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row d-flex align-items-center">
          <div class="col-md-6 order-md-12">
            <nuxt-img loading="lazy" src="/images/soluciones/instalacion-de-pistas-de-padel-min.webp" alt="Installazioni di campi da padel" />
          </div>
          <div class="col-md-6 order-md-1">
            <div class="mb-3" v-html="content.secondSection?.leftColumn"></div>
            <div class="text-center">
              <NuxtLink class="btn btn-secondary" rel="" to="/it/campi"
              >Vedi campi</NuxtLink>
            </div>
          </div>
    ...
    <section class="two-col-section">
      <div class="container">
        <div class="row d-flex align-items-center flex-column-reverse flex-md-row">
          <div class="col-md-6 ">
            <nuxt-img  loading="lazy" src="/images/soluciones/iluminacion-y-climatizacion-de-pistas-de-padel-min.webp" alt="Illuminazione, climatizzazione e stampa personalizzata dei campi da padel" />
          </div>
          <div class="col-md-6">
...
const { data } = await useAsyncData(
  'soluciones-page',
  () => find<DefaultContent>('soluciones-page', {locale: "it"})
)
