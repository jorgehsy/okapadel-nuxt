    ...
    <section class="two-col-section">
      <div class="container">
        <div class="row d-flex align-items-center">
          <div class="col-md-6">
            <nuxt-img  loading="lazy" src="/images/soluciones/cubrimos-las-instalaciones-del-club-min.jpg" alt="Padel court canopy." />
          </div>
          <div class="col-md-6">
      ...
      <div class="container">
        <div class="row d-flex align-items-center">
          <div class="col-md-6 order-md-12">
            <nuxt-img loading="lazy" src="/images/soluciones/instalacion-de-pistas-de-padel-min.jpg" alt="Installation of padel courts" />
          </div>
    ...
    <section class="two-col-section">
      <div class="container">
        <div class="row d-flex align-items-center flex-column-reverse flex-md-row">
          <div class="col-md-6 ">
            <nuxt-img  loading="lazy" src="/images/soluciones/iluminacion-y-climatizacion-de-pistas-de-padel-min.jpg" alt="Lighting, climate control, and personalized signage for padel courts" />
          </div>
          <div class="col-md-6">
