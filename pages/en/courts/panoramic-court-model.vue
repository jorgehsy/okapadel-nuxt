  ...
  <div>
      ...
      <div class="container">
        <div class="row d-flex align-items-center">
          ...
          <div class="col-md-6 two-col-section">
            <img  src="~/assets/images/pistas__modelo_panoramic_court/la-pista-de-padel-panoramic-court-min.webp" alt="A panoramic padel court of high quality with an open-plan layout." />
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="two-col-section">
      <div class="container">
        <div class="row d-flex align-items-center">
          <div class="col-md-6">
            <img  src="~/assets/images/pistas__modelo_panoramic_court/sujecion-min.webp" alt="Fasteners and anchors for Okapadel's Panoramic Courts.  " />
          </div>
          <div class="col-md-6">
    ...
    <section class="two-col-section">
      <div class="container">
        <div class="row d-flex align-items-center">
          <div class="col-md-6">
              <img  src="~/assets/images/pistas__modelo_panoramic_court/pintura-min.webp" alt="Highly durable ecological paints"/>
          </div>
      ...
      <div class="container">
        <div class="row d-flex align-items-center">
          <div class="col-md-6 order-lg-12">
            <img  src="~/assets/images/pistas__modelo_panoramic_court/cesped-min.webp" alt="Panoramic padel court turf. "/>
          </div>
          <div class="col-md-6">
    ...
    <section class="two-col-section">
      <div class="container">
        <div class="row d-flex align-items-center">
          <div class="col-md-6">
            <img  src="~/assets/images/pistas__modelo_panoramic_court/iluminacion-min.webp" alt="LED lighting for padel courts "/>
          </div>
          <div class="col-md-6">
    ...
    <section class="two-col-section">
      <div class="container">
        <div class="row d-flex align-items-center">
          <div class="col-md-6 order-lg-12">
            <img  src="~/assets/images/personalizacion.svg" alt="Your panoramic padel court adapted to your needs and image" />
          </div>
          <div class="col-md-6">
        ...
        <div class="row d-flex align-items-center justify-content-center next-page-button">
          <div class="col-md-6 text-center">
            <NuxtLink class="nav-link" rel="" to="/en/courts/basic-court-model"
              ><i class="fa-fw fa-solid fa-plus g-text"></i>See our Basic Court 
            </NuxtLink>
          </div>
        </div>
      </div>
