        ...
        <div class="row d-flex align-items-center">
          ...
          <div class="col-md-6">
            ...
            <div class="button-box">
              <NuxtLink class="btn btn-white" to="/en/courts/basic-court-model" rel="next">Ver pista Basic</NuxtLink>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row d-flex align-items-center flex-md-row">
          ...
          <div class="col-md-6">
            ...
            <div class="button-box">
              <NuxtLink class="btn btn-white" to="/en/courts/panoramic-court-model" rel="next">Ver pista Panoramic</NuxtLink>
            </div>
          </div>
        </div>
      </div>
