  ...
  <div>
      ...
      <div class="container">
        <div class="row d-flex align-items-center">
          ...
          <div class="col-md-6 two-col-section">
            <nuxt-img  loading="lazy" src="/images/pistas__modelo_panoramic_court/la-pista-de-padel-panoramic-court-min.jpg" alt="Pista de pádel panorámica diáfana de alta calidad" />
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="two-col-section">
      <div class="container">
        <div class="row d-flex align-items-center">
          <div class="col-md-6">
            <nuxt-img  loading="lazy" src="/images/pistas__modelo_panoramic_court/sujecion-min.jpg" alt="Sujecciones y anclajes para las pistas panorámicas de Okapadel" />
          </div>
          <div class="col-md-6">
    ...
    <section class="two-col-section">
      <div class="container">
        <div class="row d-flex align-items-center">
          <div class="col-md-6">
              <nuxt-img  loading="lazy" src="/images/pistas__modelo_panoramic_court/pintura-min.jpg" alt="Pinturas ecológicas de gran durabilidad"/>
          </div>
      ...
      <div class="container">
        <div class="row d-flex align-items-center">
          <div class="col-md-6 order-lg-12">
            <nuxt-img  loading="lazy" src="/images/pistas__modelo_panoramic_court/cesped-min.jpg" alt="Césped pistas de pádel panorámicas"/>
          </div>
          <div class="col-md-6">
    ...
    <section class="two-col-section">
      <div class="container">
        <div class="row d-flex align-items-center">
          <div class="col-md-6">
            <nuxt-img  loading="lazy" src="/images/pistas__modelo_panoramic_court/iluminacion-min.jpg" alt="Iluminación LED para pistas de pádel"/>
          </div>
          <div class="col-md-6">
