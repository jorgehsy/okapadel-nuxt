  ...
  <div>
    ...
    <section class="two-col-section">
      <div class="container">
        <div class="row d-flex align-items-center">
          ...
          <div class="col-md-6 mt-3"><img  src="~/assets/images/nosotros/que-es-okapadel--min.webp" /></div>
        </div>
      </div>
    </section>
    ...
    <section class="two-col-section w-text blue-bg">
      <div class="container">
        <div class="row d-flex align-items-center">
          <div class="col-md-6">
            <img  src="~/assets/images/nosotros/por-que-se-creo_okapadel.-min.webp" />
          </div>
          <div class="col-md-6">
    ...
    <section class="two-col-section gray-bg">
      <div class="container">
        <div class="row d-flex align-items-center">
          ...
          <div class="col-md-6 mt-3"><img  src="~/assets/images/nosotros/y-ademas-encontramos-patrocinio-para-tu-club-min.webp" /></div>
        </div>
      </div>
    </section>
