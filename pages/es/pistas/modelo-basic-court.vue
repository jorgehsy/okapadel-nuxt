  ...
  <div>
      ...
      <div class="container">
        <div class="row d-flex align-items-center">
          <div class="col-md-6 order-lg-12">
            <nuxt-img  loading="lazy" src="/images/pistas__modelo_basic_court/cesped-min.webp" alt="cesped de cancha de padel" />
          </div>
          <div class="col-md-6">
    ...
    <section class="two-col-section">
      <div class="container">
        <div class="row d-flex align-items-center">
          <div class="col-md-6">
            <nuxt-img  loading="lazy" src="/images/pistas__modelo_basic_court/iluminacion-min.webp" alt="focos pista de pádel - Iluminación led para pistas de pádel" />
          </div>
          <div class="col-md-6">
