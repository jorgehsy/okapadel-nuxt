    ...
    <section class="two-col-section">
      <div class="container">
        <div class="row d-flex align-items-center">
          <div class="col-md-6">
            <img  src="~/assets/images/soluciones/cubrimos-las-instalaciones-del-club-min.webp" alt="cubierta pista de padel" />
          </div>
          <div class="col-md-6">
            <div class="mb-3" v-html="content.firstSection?.rightColumn"></div>
            <div class="text-center">
              <NuxtLink class="btn btn-secondary" rel="" to="/es/cubiertas/"
      ...
      <div class="container">
        <div class="row d-flex align-items-center">
          <div class="col-md-6 order-md-12">
            <img src="~/assets/images/soluciones/instalacion-de-pistas-de-padel-min.webp" alt="Instalación de pistas de pádel" />
          </div>
          <div class="col-md-6 order-md-1">
            <div class="mb-3" v-html="content.secondSection?.leftColumn"></div>
            <div class="text-center">
              <NuxtLink class="btn btn-secondary" rel="" to="/es/pistas/"
              >Ver pistas</NuxtLink>
            </div>
          </div>
    ...
    <section class="two-col-section">
      <div class="container">
        <div class="row d-flex align-items-center flex-column-reverse flex-md-row">
          <div class="col-md-6 ">
            <img  src="~/assets/images/soluciones/iluminacion-y-climatizacion-de-pistas-de-padel-min.webp" alt="cubierta pista de padel" />
          </div>
          <div class="col-md-6">
